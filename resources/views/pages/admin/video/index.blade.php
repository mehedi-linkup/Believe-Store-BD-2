                        ...
                        <tbody>
                            @forelse ($video as $key=>$item)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td>
                                        <iframe width="100%" height="150" src="{{ $item->link }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                                    </td>                            
                                    <td>
